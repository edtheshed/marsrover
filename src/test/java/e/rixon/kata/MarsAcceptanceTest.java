...
public class MarsAcceptanceTest {
    ...
    private StringCommandParser stringCommandParser;
    ...
    void rover_can_move_on_a_grid() {
        ...
        service.setRover(5, 5, Direction.NORTH, stringCommandParser.parseCommands("LMLMRMLMRRMMMLMM"));
    ...
    void rover_can_finish_where_it_started_if_only_move_forward() {
        ...
        service.setRover(1, 1, Direction.NORTH, stringCommandParser.parseCommands("MMMLMMM"));
        service.executeCommands();
    ...
    void rover_cant_pass_through_an_obstacle() {
        ...
        service.setRover(1, 1, Direction.NORTH, stringCommandParser.parseCommands("MMM"));
        service.executeCommands();
...
//    @Test
    void rover_cant_pass_through_another_rover() {
        ...
        service.setRover(1, 1, Direction.NORTH, stringCommandParser.parseCommands("MMMM"));
        service.setRover(1, 3, Direction.NORTH, stringCommandParser.parseCommands("MMMM"));
        service.executeCommands();
